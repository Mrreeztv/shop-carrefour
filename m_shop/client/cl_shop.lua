...
local mfdev = {
	Base = { Header = {"interaction_bgd", "interaction_bgd"}, Title = "Carrefour"},
	Data = { currentMenu = "Carrefour", "Carrefour" },
	Events = {
...
Citizen.CreateThread(function()
	while true do
		...
		for k in pairs(pos) do
			...
			if dist <= 1.5 then
				ESX.ShowHelpNotification("Appuyez sur [~b~E~s~] pour accéder a ~b~Carrefour !")
...
Citizen.CreateThread(function()
	...
	for i=1, #Config.Shops, 1 do
        ...
        AddTextComponentString("Carrefour")
...
print ('^6(Crée par ^4Mrfreez') print ('^6https://discord.gg/WpjMgsZ5aK')
